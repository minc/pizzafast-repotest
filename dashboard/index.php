                    ...
                    <div class="col-md-4 col-md-offset-4">
                        <div class="login">
                            <div class="logo" href="#" align="">
                                <img src="http://fooddelivery.viavilab.com/upload/admin_logo.png" alt="logo">
                            </div>
                            <div class="panel panel-default panel-shadow">
                                <form accept-charset="UTF-8" class="" id="loginform" role="form">
                                    <div class="panel-body">
                                    	...
                                    	<div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="email" id="email" placeholder="Insira o usuário">
                                        </div>
                                        <div class="form-group margin-none">
                                            <div class="media">
                                                ...
                                                <div class="media-right media-middle">
                                                    <a href="enviaSenha.php" class="small pull-right">Esqueceu?</a>
                                                </div>
                                            </div>
                                    ...
                                    <div class="form-group text-center">
                                        <button type="button" class="btn btn-primary">Login&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-unlock-alt"></i></button>
                                    </div>
                                </form> 
                            </div>
                        </div>
